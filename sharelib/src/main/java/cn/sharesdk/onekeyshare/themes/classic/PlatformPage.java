...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,110);
		lp2.weight = 1;
		lp2.setMargins(20, 20, 20, 0);
		buttonLayout.setBackgroundResource(R.drawable.layer_list_share_dialog_top_bg);
		TextView tv = new TextView(activity);
		tv.setGravity(Gravity.LEFT);
		tv.setText("Share this property");
		tv.setTextSize(16);
		tv.setTextColor(Color.BLACK);
		ImageView ivClose = new ImageView(getContext());
		ivClose.setBackgroundResource(R.mipmap.ic_launcher);
